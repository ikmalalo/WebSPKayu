        ...
        create: [
          {
            ...
            nama: 'Indikator ID1',
            deskripsi:
              'Indikator ID1 pada Hifzh ad-Din',
          ...
          },
          {
            ...
            nama: 'Indikator ID2',
            deskripsi:
              'Indikator ID2 pada Hifzh ad-Din',
            tipe: IndikatorTipe.POSITIF,
            urutan: 2,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID3',
            deskripsi:
              'Indikator ID3 pada Hifzh ad-Din',
            tipe: IndikatorTipe.POSITIF,
            urutan: 3,
            aktif: true,
          },
        ...
        create: [
          {
            ...
            nama: 'Indikator ID4',
            deskripsi:
              'Indikator ID4 pada Hifzh an-Nafs',
            tipe: IndikatorTipe.POSITIF,
            urutan: 4,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID5',
            deskripsi:
              'Indikator ID5 pada Hifzh an-Nafs',
            tipe: IndikatorTipe.POSITIF,
            urutan: 5,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID6',
            deskripsi:
              'Indikator ID6 pada Hifzh an-Nafs',
        ...
        create: [
          {
            ...
            nama: 'Indikator ID7',
            deskripsi:
              "Indikator ID7 pada Hifzh al-'Aql",
            tipe: IndikatorTipe.POSITIF,
            urutan: 7,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID8',
            deskripsi:
              "Indikator ID8 pada Hifzh al-'Aql",
            tipe: IndikatorTipe.POSITIF,
            urutan: 8,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID9',
            deskripsi:
              "Indikator ID9 pada Hifzh al-'Aql",
            tipe: IndikatorTipe.POSITIF,
            urutan: 9,
            aktif: true,
          },
        ...
        create: [
          {
            ...
            nama: 'Indikator ID10',
            deskripsi:
              'Indikator ID10 pada Hifzh an-Nasl',
            tipe: IndikatorTipe.POSITIF,
            urutan: 10,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID11',
            deskripsi:
              'Indikator ID11 pada Hifzh an-Nasl',
            tipe: IndikatorTipe.POSITIF,
            urutan: 11,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID12',
            deskripsi:
              'Indikator ID12 pada Hifzh an-Nasl',
            tipe: IndikatorTipe.POSITIF,
            urutan: 12,
            aktif: true,
          },
        ...
        create: [
          {
            ...
            nama: 'Indikator ID13',
            deskripsi:
              'Indikator ID13 pada Hifzh al-Mal',
            tipe: IndikatorTipe.POSITIF,
            urutan: 13,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID14',
            deskripsi:
              'Indikator ID14 pada Hifzh al-Mal',
            tipe: IndikatorTipe.POSITIF,
            urutan: 14,
            aktif: true,
          },
          {
            ...
            nama: 'Indikator ID15',
            deskripsi:
              'Indikator ID15 pada Hifzh al-Mal',
            tipe: IndikatorTipe.POSITIF,
            urutan: 15,
            aktif: true,
          },
