    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 transition-colors">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-medium text-slate-700 dark:text-slate-300">Progress Pengisian</span>
          <span className="text-sm font-bold text-green-600 dark:text-green-400">{answered}/{totalQuestions}</span>
        </div>
              ...
              <CardHeader>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-400 mt-0.5">{kriteria.deskripsi}</p>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                  ...
                  {subItems.map((sk: SubKriteria) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between flex-1">
                        <span className="text-sm text-slate-700 dark:text-slate-200">{sk.keterangan}</span>
                        <span className="text-xs font-bold text-slate-400 dark:text-slate-500 ml-2">Nilai: {sk.nilai}</span>
                      </div>
                    </label>
                  ))}
                </div>
